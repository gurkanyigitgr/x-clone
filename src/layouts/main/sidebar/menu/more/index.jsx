  ...
  return (
    <Popover className='relative'>
      <Popover.Button className='py-[3px] block group outline-none'>
        <div className='p-3 rounded-full transition-colors inline-flex item-center gap-5 group-hover:bg-[#eff3f41a]'>
      ...
      <Popover.Panel className='w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden'>
        <button className='p-3 h-14 w-full transition-colors inline-flex item-center gap-5 hover:bg-[#eff3f41a]'>
          <div className='w-[26.25px] h-[26.25px] relative'>
            <svg viewBox='0 0 24 24' width={26.25} height={26.25}>
              <path
                fill='#e7e9ea'
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className='text-gray-500'>
            <Link
              to='/'
              className='flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-[#e7e9ea] hover:bg-[#eff3f41a] transition-colors'
            >
              <svg viewBox='0 0 24 24' width={18.75} height={18.75}>
                <path
                  fill='currentColor'
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className='text-gray-500'>
            <Link
              to='/'
              className='flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-[#e7e9ea] hover:bg-[#eff3f41a] transition-colors relative'
            >
              <svg viewBox='0 0 24 24' width={18.75} height={18.75}>
                <path
                  fill='currentColor'
